...
6/11까지는 백필 작업의 PUT 요청이 섞여 있어 수치가 높지만, 6/12부터는 백필이 끝난 뒤 순수 운영 수치입니다. 6/12~13에서 안정화되어 Requests/GB가 6,016에서 1,282로 **79% 감소** — 같은 양의 데이터를 읽는 데 필요한 요청 수가 대폭 줄었습니다.
